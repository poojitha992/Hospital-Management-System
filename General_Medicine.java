...
public class General_Medicine extends JFrame {
    ...
    General_Medicine() throws ClassNotFoundException, SQLException {
        Class.forName("com.mysql.cj.jdbc.Driver");
        conn = DriverManager.getConnection("jdbc:mysql://localhost/test", "root", "@Hanumaan12@");
        stmt = conn.createStatement();
        l = new JLabel("Doctors in General Medicine");
        l.setBounds(120, 40, 350, 50);
        l.setFont(l.getFont().deriveFont(25.0f));
        p.add(l);
        String s = "Select * from Doctor where Spec='General Medicine'";
        try {
